...
var BuildCommand = class extends import_clipanion.Command {
  ...
  static usage = import_clipanion.Command.Usage({
    category: "Build",
    description: "Build Apps In Toss artifact",
...
var InitCommand = class extends import_clipanion3.Command {
  static paths = [[`init`]];
  template = import_clipanion3.Option.String("--template", { required: false });
  appName = import_clipanion3.Option.String("--app-name", { required: false });
